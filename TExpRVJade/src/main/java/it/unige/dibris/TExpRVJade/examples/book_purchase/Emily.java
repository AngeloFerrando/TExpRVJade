...
public class Emily extends Agent{
	...
	protected void setup() {
		...
		addBehaviour(new CyclicBehaviour(this) {
			...
			public void action() {
				...
				if(msgR != null && msgR.getContent().equals("send_me_book")){
					...
					System.out.println("[" + getLocalName() + "]: send " + "book_available" + " to " + "carol");
