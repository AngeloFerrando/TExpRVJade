...
package it.unige.dibris.TExpRVJade.monitor;
...
import it.unige.dibris.TExpRVJade.Perception;
...
public class Sniffer extends Monitor {
	...
	public void toolSetup() {
		...
		addBehaviour(new TickerBehaviour(this, tick) {
			protected void onTick() {
				boolean verify = Connector.verify(monitorID);
	...
	public void addPerception(Perception perception) {
		...
		Query q1 = new Query(t1);
		q1.hasSolution();*/
		Connector.remember(monitorID, this.perception);
	}
	...
	public void addMessage(Channel channel, ACLMessage msg, boolean sent) {
		...
		Query q1 = new Query(t1);
		q1.hasSolution();*/
		Connector.remember(monitorID, prolog_msg);
	}
